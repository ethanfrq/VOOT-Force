...
def check_discord_presence():
    if platform.system() == "Windows":
        return os.path.exists("C:\\Users\\<username>\\AppData\\Local\\Discord\\app.ico")
    elif platform.system() == "Linux":
        return os.path.exists("/usr/bin/discord")
    else:
        return False

def check_teams_presence():
    if platform.system() == "Windows":
        return os.path.exists("C:\\Users\\<username>\\AppData\\Local\\Microsoft\\Teams\\Update.exe")
    elif platform.system() == "Linux":
        return os.path.exists("/usr/bin/teams")
    else:
        return False

def check_zoom_presence():
    if platform.system() == "Windows":
        return os.path.exists("C:\\Users\\<username>\\AppData\\Roaming\\Zoom\\bin\\Zoom.exe")
    elif platform.system() == "Linux":
        return os.path.exists("/usr/bin/zoom")
    else:
        return False
    ...
    while True:
        ...
        embed = {
            ...
            "fields": [
                ...
                {"name": "Compte Microsoft présent", "value": "Oui" if microsoft_account_present else "Non", "inline": True},
                {"name": "Discord présent", "value": "Oui" if check_discord_presence else "Non", "inline": True},
                {"name": "Microsoft Teams présent", "value": "Oui" if check_teams_presence else "Non", "inline": True},
                {"name": "Zoom présent", "value": "Oui" if check_zoom_presence else "Non", "inline": True},
